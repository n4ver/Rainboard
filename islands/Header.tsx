        ...
        <header>
            <div id="head" class="justify-center">
                <div id="head-wrapper" class="flex-none h-full w-full flex-nowrap">
                    <div id="nav-bar" class="flex items-center bg-gradient-to-r from-indigo-500 gap-4 h-16 px-1">
                        <div id="search-wrapper" class="flex px-4">
                            <form id="search-bar" class="flex">
                                <div class="flex flex-row flex-nowrap bg-indigo-900 rounded-full min-h-full pl-2">
                                    ...
                                    <input type="text" id="search" style="background: none" required placeholder="Search..." class=" border-none outline-none text-white px-2 text-lg"></input>
                                </div>
                            </form>
                        </div>
                        <div id="nav-bar-inner" class="flex-auto gap-6 text-white">
                            <a href="/" title="Home" class="text-xl px-4">Home</a>
                            <a href="/about" title="About" class="text-xl px-4">About</a>
                            <a href="/stats" title="Tournament Statistics" class="text-xl px-4">Stats</a>
                        </div>
                        <div id="login-bar" class="flex pr-4">
                            <a href="/login" title="Log in" class="text-xl text-indigo-900">Login</a>
                        </div>
                    </div>
                </div>
            </div>
