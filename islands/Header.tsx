                        ...
                        <div id="search-wrapper" class="flex px-4">
                            <form id="search-bar" class="flex">
                                <div class="flex flex-row flex-nowrap bg-indigo-900 rounded-full min-h-full pl-2">
                                    ...
                                    <input type="text" id="search" style="background: none" required placeholder="Search..." class=" border-none outline-none text-black px-2 text-lg"></input>
                                </div>
                            </form>
                        </div>
                        <div id="nav-bar-inner" class="flex gap-4">
                            <a href="/" title="Home" class="text-xl">Home</a>
                            <a href="/about" title="About" class="text-xl">About</a>
                            <a href="/stats" title="Tournament Statistics" class="text-xl">Stats</a>
                        </div>
                        <div id="login-bar" class="flex">
                            <a href="/login" title="Log in" class="text-xl">Login</a>
                        </div>
                    </div>
                </div>
            </div>
